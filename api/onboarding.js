...
export default async function handler(req, res) {
  ...
  try {
    ...
    const data = {
      ...
      prefLenderCompany:      f('prefLenderCompany'),
      prefLenderPhone:        f('prefLenderPhone'),
      prefLenderEmail:        f('prefLenderEmail'),
      prefInspector:          f('prefInspector'),
      prefInspectorPhone:     f('prefInspectorPhone'),
      prefInspectorEmail:     f('prefInspectorEmail'),
      prefSignCompany:        f('prefSignCompany'),
      prefSignCompanyPhone:   f('prefSignCompanyPhone'),
      prefSignCompanyEmail:   f('prefSignCompanyEmail'),
      ...
      collectsBrokerCompFee:  f('collectsBrokerCompFee'),
      brokerCompFeeAmount:    f('brokerCompFeeAmount'),
