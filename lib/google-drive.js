...
async function _writeChecklistSnapshot({
  ...
  const subtitleText = isInitialWrite
    ? 'Snapshot at file creation  •  TCs work in the master TC sheet — link below'
    : `Snapshot refreshed daily at 6 PM Pacific  •  Last refresh: ${new Date().toLocaleString('en-US', { timeZone: 'America/Los_Angeles' })}`;
